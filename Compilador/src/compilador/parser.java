...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Sep 17 19:45:20 CST 2020
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  public int error_sym() {return 1;}
    ...
    public void syntax_error(Symbol s){
        found = s;
        error += "Se encontro: "+ s.value +", en la linea: "+(s.left+1)+", columna: "+(s.right+1)+"\n";
    }
    ...
    public void Main_Error(){
        switch(found.sym){
            case sym.BEGIN: 
                ...
                break;
            default:
                System.out.println("Error de Sintaxis se esperaba: end main");
                break;
        }
    }
